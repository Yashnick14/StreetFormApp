...
<div>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mt-6 flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <button onclick="openModal()"
                    class="inline-flex items-center justify-center rounded-md bg-black w-20 h-10
            ...
            <button onclick="openDeleteModalForSelected()"
                    class="inline-flex items-center justify-center rounded-md bg-red-600 w-20 h-10
    ...
    <div class="px-4 sm:px-6 lg:px-8 mt-6 relative">
        ...
        <div wire:loading wire:target="search" class="absolute inset-0 bg-white bg-opacity-75 z-10 flex items-center justify-center rounded-lg">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th wire:click="sortBy('name')"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">
                            Name
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Image</th>
                    ...
                    @forelse($products as $p)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-sm text-gray-500">{{ Str::limit($p->description,50) }}</div>
                            </td>
                                ...
                                @if(!empty($sizesArr) && $totalStock > 0)
                                    <div class="flex flex-wrap gap-2 mb-2">
                                        @foreach(['XS','S','M','L','XL'] as $size)
                                            ...
                                            <div class="relative">
                                                @if((int)$qty > 0)
                                                     <span class="inline-flex items-center justify-center w-10 h-8 text-sm font-semibold rounded-lg
                                                                {{ (int)$qty < 5 
