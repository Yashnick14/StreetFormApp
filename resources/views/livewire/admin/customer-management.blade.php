<div class="overflow-x-hidden" x-data="{ showDeleteModal: false }">
    <!-- Header -->
    <div>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mt-6 flex flex-col sm:flex-row gap-4 sm:gap-0 sm:justify-between sm:items-center">
        ...
        <div class="flex gap-3 flex-wrap sm:flex-nowrap">
            ...
            <button 
                type="button"
                :disabled="!@this.get('selectedCustomer')"
                @click="if (@this.get('selectedCustomer')) showDeleteModal = true"
                class="inline-flex items-center justify-center rounded-md bg-red-700 w-full sm:w-20 h-10
                    text-sm font-semibold text-white shadow-sm hover:bg-red-800 disabled:bg-gray-500">
                Delete
            </button>
        </div>
    </div>
                ...
                <div class="inline-block transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="bg-gray-50 px-6 py-3 flex justify-end space-x-3">
                            ...
                            <button type="submit"
                                    class="px-4 py-2 rounded-md bg-black text-white font-semibold shadow hover:bg-gray-800">
                                Update
                            </button>
                        </div>
                    </form>
    ...
    >
        ...
        <!-- Modal Content -->
        <div class="flex flex-col items-center bg-white shadow-md rounded-xl py-6 px-5 md:w-[460px] w-[370px] border border-gray-200 relative z-10">
            ...
            <p class="text-sm text-gray-600 mt-2 text-center">
                Do you really want to delete this customer?<br>This action cannot be undone.
            </p>
            <div class="flex items-center justify-center gap-4 mt-5 w-full">
                ...
                <button type="button" wire:click="deleteSelected" @click="showDeleteModal = false"
