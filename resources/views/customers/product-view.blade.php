                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3">
                            <button type="button"
                                    ...
                                    class="w-full px-6 py-3 border-2 border-gray-900 bg-white hover:bg-gray-50 
                                        text-gray-900 font-semibold rounded-md transition">
                                <span x-show="!isLoading">Add to Cart</span>
                                <span x-show="isLoading">Adding...</span>
                            </button>

                            <button type="button"
                                    class="w-full px-6 py-3 border-2 border-gray-900 bg-gray-900 hover:bg-black 
